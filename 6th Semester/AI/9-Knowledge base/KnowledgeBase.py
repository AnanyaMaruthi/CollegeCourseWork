...
def fol_fc_ask(kb, alpha):
    ...
    kb_consts = list({c for clause in kb.clauses for c in aima.logic.constant_symbols(clause)})

    def enum_subst(p):
        query_vars = list({v for clause in p for v in aima.logic.variables(clause)})
